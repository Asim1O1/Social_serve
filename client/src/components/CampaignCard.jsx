...
function CampaignCard({ campaign, choseCampaign, handleRegister }) {
    ...
    return (
        <div
            className="hover:shadow-md shadow text-accent  group hover:scale-101 p-4 bg-primary/10 space-y-4 relative rounded-xl overflow-hidden transition-all duration-300">
            <ActionsMenu
                popup={popup}
                campaign={campaign}
