...
function CampaignActionsMenu({ popup, event, setOpenModal, popupRef }) {
    if (popup !== event.id) return null;
    ...
    return (
        ...
        >
            <Link to={`/create-campaign/${event.id}`} className=" p-2 hover:bg-gray-100 w-full flex items-center gap-2">
                <Pencil size={16} /> Edit
            </Link>
